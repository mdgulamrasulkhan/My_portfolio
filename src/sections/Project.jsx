    ...
    () => [
      {
        ...
        link: "https://github.com/mdgulamrasulkhan/netflix-gemini",
        bgColor: "#0D0D0D",
        image: isMobile ? photo1 : img1, // use mobile or desktop image
      },
      {
        title: "Smart Email Assistant",
        link: "https://github.com/mdgulamrasulkhan/-Smart-Email-Assistant",
        bgColor: "#3884d3",
        image: isMobile ? photo2 : img2,
      },
      {
        title: "My Youtube",
        link: "https://apnaayoutube.netlify.app/",
        bgColor: "#dc9317",
  ...
  <FaArrowUp className="text-yellow-400 animate-bounce" />
        ...
        >
          {Projects.map((project, idx) => (
            <div
              key={project.title}
              className={`absolute top-1/2 left-1/2 -translate-1/2 transition-all duration-500 ${
                activeIndex === idx
                  ? "opacity-100 z-20"
