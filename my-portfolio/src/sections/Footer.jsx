...
const socials = [
  {
    Icon: FaLinkedin,
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/mdkhan43/",
  },
  {
    Icon: FaGithub,
    label: "GitHub",
    href: "https://github.com/mdgulamrasulkhan",
  },

  {
    Icon: SiGooglecloud,
    label: "Googlecloud",
    href: " https://www.skills.google/public_profiles/4afa20ae-48ae-44e0-9ae3-c7ed721cd091",
  },
    ...
    <footer className="relative overflow-hidden bg-black">
      ...
      >
        <h1
          ...
          style={{
            fontSize: "clamp(1.5rem, 2.5vw, 7rem)",
        ...
        <p className="text-gray-300 italic max-w-xl">
          “When effort becomes a habit, success becomes a lifestyle.”
        </p>
        <p className="text-xs text-gray-400">
          &copy; {new Date().getFullYear()} Md Gulam Rasul Khan. All rights
          reserved.
        </p>
      </motion.div>
    </footer>
