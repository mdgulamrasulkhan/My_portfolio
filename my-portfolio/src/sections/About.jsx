  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        <motion.div
          className="flex flex-col md:flex-row items-center md:item-stretch gap-8 "
    ...
    rounded-2xl overflow-hidden shadow-2xl 
     bg-gradient-to-br from-[#1cd8d2]/20 to-[#302b63]/20  border border-[#1cd8d2]/25 flex items-center justify-center sm:mb-45 md:mb-35"
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            <h2
              className="text-3xl sm:text-4xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r
          from-[#1cd8d2] via-[#00bf8f] to-[#1cd8d2]
          "
            >
              MD GULAM RASUL KHAN
            </h2>
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-base  max-w-2xl md:max-w-3xl">
              ...
              Java, React.js, JavaScript, Tailwind CSS, MySql and
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
              {stats.map((item, i) => (
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.05 * i, amount: 0.3 }}
                >
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
            ...
            passionate about building fast, resilient applications.
          </p>
