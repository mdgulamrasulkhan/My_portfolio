...
const experiences = [
  {
    role: "JAVA - intern",
    company: "Next Innovate Techno Solutions",
    duration: "2024",
    description: "Learn java fundamental and gained hands-on-knowlwge.",
  },

  {
    role: "Frontend Developer",
    company: "Cloud Vertex",
    duration: "2024-2025",
    description:
    ...
    return (
      <div className="relative flex flex-1 justify-center items-center min-w-0">
        ...
        >
          ...
          <p className="text-mid text-gray-400 mb-3">
